...
public class LordRoyce extends HeroCard {
    ...
    /**
     * Method to use Lord Royce's special ability: freezes the card with the biggest attackDamage
     * @param cards opponent's cards
     */
    public void subZero(final ArrayList<Card> cards) {
        int maxAttack = -1;
        int maxAttackPos = 0;
        ...
        cards.get(maxAttackPos).setFrozen(true);
    }
    ...
    /**
     * Getter for the 'hasAttacked' field
    ...
    /**
     * Setter for the 'hasAttacked' field
